...
# Set up Telegram bot
token = "7233743314:AAF2d-15_RfhJpRlgyGykN6UbqZ-5VIjaDc"
...
def echo_message(message):
  ...
  try:
    ...
    if "من صنعك" in user_message or "من هو صاحبك" in user_message or "من أنشأك" in user_message  or "من مطورك " in user_message  or "من مبرمج البوت " in user_message  or "من مبرمجك " in user_message  or "من مطور البوت " in user_message:
      bot.send_message(message.chat.id, "أنا نموذج لغوي كبير تم صناعتي من قبل المطور انوبيس")

    # Add information about the engineer
    elif" من هو انوبيس" in user_message or "من هو المطور انوبيس" in user_message  or "انوبيس" in user_message:
      bot.send_message(message.chat.id, "المطور انوبيس هوا مطور بوتات كثيره مثل بوتات اختراق وبوتات chatgptوهو الذي صنعني وهو مطوري وهذا هو معرفه تيليجرام@N_M_X2.")
